...
public class ExtentTestNGIReporterListener implements IReporter {
	...
	private void init(ISuite suite) {
		...
		ExtentSparkReporter htmlReporter = new ExtentSparkReporter(Global_VARS.REPORT_PATH);
		...
		extent.setSystemInfo("Selenium Version", System.getProperty("selenium.revision"));
		
		extent.attachReporter(htmlReporter);
		extent.setReportUsesManualConfiguration(true);
	}
	
	public void processTestResults(ISuiteResult r) throws Exception {
